  ...
  const generateImage = async () => {
    if(form.prompt) {
      try {
        ...
        const response = await fetch("http://localhost:8080/api/v1/aeyes", {
          method: 'POST',
          headers: {
  ...
  return (
    <section className="max-w-7xl mx-auto">
     <div>
      ...
      [500px]">Create some extraordinary images through AEyes- AI and share them with the community</p>
    </div>
    <form className='mt-16 max-w-3xl' onSubmit={handleSubmit}>
     ...
     <div className="mt-5 flex gap-5">
      <button
       ...
       className="text-white bg-purple-700 font-medium rounded-md text-sm w-full sm:w-auto px-5 py-2.5 
       text-center"
      >
